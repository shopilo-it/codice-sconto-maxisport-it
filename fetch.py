#!/usr/bin/env python3
"""
Recupero codici sconto Maxi Sport IT da shopilo.it
Sursa: https://shopilo.it/negozi/maxisport.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/maxisport.it"
STORE_NAME = "Maxi Sport IT"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Maxi Sport IT da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-maxisport-it)"
    }
    try:
